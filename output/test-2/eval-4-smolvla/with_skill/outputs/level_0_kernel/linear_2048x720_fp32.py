"""
Component: Linear 2048x720 (Expert MLP down projection)
Abstraction Level: kernel
Parent: Expert Transformer Block MLP
Children: []
Operations: nn.Linear
Input Shapes: - x: (1, 50, 2048) dtype=float32
Output Shapes: - output: (1, 50, 720) dtype=float32
Weight Shapes: - linear.weight: (720, 2048)
"""
import torch
