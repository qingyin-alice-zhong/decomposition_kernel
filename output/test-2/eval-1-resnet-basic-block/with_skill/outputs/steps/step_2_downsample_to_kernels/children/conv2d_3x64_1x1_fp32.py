"""
Component: Conv2d (3->64, 1x1, stride=1, no bias)
Abstraction Level: kernel
Parent: downsample_conv_bn_3x64_1x1_fp32
Children: []
...
class Model(nn.Module):
    """
    Conv2d kernel: 3->64, 1x1, stride=1, bias=False.
    Extracted from: ResNet BasicBlock downsample conv
    """
