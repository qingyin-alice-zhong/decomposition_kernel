"""
Step 2b: Conv+BN fusion (L1) -> Kernels (L0)

Decomposes conv_bn into:
  - conv2d_64x64_3x3_fp32 (L0)
...
from conv2d_64x64_3x3_fp32 import Model as Conv2d
from batchnorm2d_64_fp32 import Model as BatchNorm2d


class RefactoredModel(nn.Module):
    """
    Refactored Conv+BN fusion using kernel modules.
    """
