"""
Component: Conv2d (3->64, 3x3, stride=1, padding=1, no bias)
Abstraction Level: kernel
Parent: conv_bn_relu_3x64_3x3_fp32
Children: []
...
class Model(nn.Module):
    """
    Conv2d kernel: 3->64, 3x3, stride=1, padding=1, bias=False.
    Extracted from: ResNet BasicBlock conv1
    """
