"""
Component: Linear 960x720 (Expert O projection)
Abstraction Level: kernel
Parent: Expert Transformer Block
Children: []
Operations: nn.Linear
Input Shapes: - x: (1, L, 960) dtype=float32
Output Shapes: - output: (1, L, 720) dtype=float32
Weight Shapes: - linear.weight: (720, 960)
"""
import torch
