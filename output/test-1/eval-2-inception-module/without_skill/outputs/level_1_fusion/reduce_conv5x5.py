"""
Fusion-level component: 1x1 Reduction + 5x5 Convolution.
Fuses a 1x1 channel reduction convolution followed by a 5x5 convolution.
This is the core computation pattern of the 5x5 branch in an Inception module.
"""
import torch
...
class Model(nn.Module):
    """Fused 1x1 reduction followed by 5x5 convolution."""
    def __init__(self, in_channels, reduce_channels, out_channels):
        ...
        self.conv = nn.Conv2d(reduce_channels, out_channels, kernel_size=5, padding=2)
