"""
Component: ReLU Activation
Source: data/kernelbench/level3/8_ResNetBasicBlock.py
Abstraction Level: kernel
Parent: conv_bn_relu, resnet_basic_block
...
class Model(nn.Module):
    """
    Single ReLU activation (elementwise, shape-independent).

    Extracted from: resnet_basic_block (relu after conv_bn_relu and after residual add)
    """
    def __init__(self):
        super().__init__()
