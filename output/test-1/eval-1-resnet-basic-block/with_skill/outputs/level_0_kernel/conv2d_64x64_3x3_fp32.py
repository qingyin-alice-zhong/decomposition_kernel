"""
Component: Conv2d 64->64, kernel 3x3
...
class Model(nn.Module):
    """
    Single Conv2d operation: in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1.

    Extracted from: conv_bn fusion (conv2 in resnet_basic_block)
    """
