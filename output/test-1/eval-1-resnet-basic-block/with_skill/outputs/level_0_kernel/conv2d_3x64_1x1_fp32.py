"""
Component: Conv2d 3->64, kernel 1x1
...
class Model(nn.Module):
    """
    Single Conv2d operation: in_channels=3, out_channels=64, kernel_size=1, stride=1.

    Extracted from: downsample fusion (downsample.0 in resnet_basic_block)
    """
