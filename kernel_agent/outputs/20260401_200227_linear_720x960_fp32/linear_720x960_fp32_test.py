...
def run_tiled_linear(mod, x: np.ndarray, weight: np.ndarray):
    ...
    print(
        f"Executed {tile_count} tiles for linear_720x960_fp32 "
...
def _test(kernel_path: str):
    print(
        "Running tiled validation for linear_720x960_fp32: "
        f"shape=(1,50,720)->(1,50,960), out_tile={OUT_TILE}, abi_tile={ABI_TILE}"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--kernel_path", type=str, default="linear_720x960_fp32.cc")
