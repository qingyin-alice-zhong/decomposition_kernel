...
def _build_top(kernel_path: str):
    k = ExternalModule(top="rms_norm_960_fp32", impl_path=kernel_path, input_idx=[0, 2], output_idx=[1])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--kernel_path", type=str, default="rms_norm_960_fp32.cc")
