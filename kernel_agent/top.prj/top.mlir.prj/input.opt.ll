...
declare void @linear_12288x960_fp32(ptr, ptr, ptr) local_unnamed_addr
...
1:                                                ; preds = %0, %1
  ...
  tail call void @linear_12288x960_fp32(ptr nonnull @fifo_0_cons_buff_0, ptr nonnull @fifo_4_buff_0, ptr nonnull @fifo_2_cons_buff_0)
  ...
  tail call void @linear_12288x960_fp32(ptr nonnull @fifo_0_cons_buff_1, ptr nonnull @fifo_4_buff_1, ptr nonnull @fifo_2_cons_buff_1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  tail call void @llvm.aie2.release(i32 50, i32 1)
