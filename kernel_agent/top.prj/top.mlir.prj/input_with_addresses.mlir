module {
  aie.device(npu1_4col) {
    ...
    aie.flow(%mem_tile_3_1, DMA : 0, %tile_0_3, DMA : 0)
    ...
    aie.flow(%shim_noc_tile_1_0, DMA : 1, %mem_tile_0_1, DMA : 3)
    aie.flow(%mem_tile_0_1, DMA : 4, %tile_0_4, DMA : 1)
    aie.flow(%shim_noc_tile_2_0, DMA : 0, %mem_tile_0_1, DMA : 4)
    aie.flow(%tile_0_4, DMA : 0, %mem_tile_0_1, DMA : 5)
    aie.flow(%mem_tile_0_1, DMA : 5, %shim_noc_tile_0_0, DMA : 1)
    aie.flow(%mem_tile_1_1, DMA : 1, %tile_1_2, DMA : 0)
    aie.flow(%shim_noc_tile_2_0, DMA : 1, %mem_tile_1_1, DMA : 1)
    aie.flow(%mem_tile_1_1, DMA : 2, %tile_1_2, DMA : 1)
    aie.flow(%shim_noc_tile_3_0, DMA : 1, %mem_tile_1_1, DMA : 2)
