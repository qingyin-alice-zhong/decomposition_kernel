"""
Component: Linear 1440x720 (Action-Time MLP input, with bias)
Abstraction Level: kernel
Parent: Action-Time MLP
Children: []
Operations: nn.Linear
Input Shapes: - x: (1, 50, 1440) dtype=float32
Output Shapes: - output: (1, 50, 720) dtype=float32
Weight Shapes: - linear.weight: (720, 1440), linear.bias: (720,)
"""
import torch
